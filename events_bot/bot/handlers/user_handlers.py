...
**Основные функции:**
• 📮 Смотреть подборку - просмотр актуальных мероприятий в выбранных категориях
• ❤️ Избранное - просмотр мероприятий, добавленных в личный список избранного
• ✏️ Создать мероприятие - Публикация в боте собственного события (после одобрения оно будет доступно всем пользователям бота)
• ⭐️ Изменить категории - смена категориий для получения уведомлений о новых событиях
• 🎓 Изменить университет - смена ВУЗа для получения уведомлений о новых событиях
• 🏠 Главное меню - /main_menu

📋 **Как использовать:**
1. Выберите интересующий ВУЗ
2. Выберите категории интересующих мероприятий
3. Получайте уведомления о новых мероприятиях в вашем ВУЗе
4. Создавайте свои мероприятия в выбранных категориях
